...
<!--        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
              <input class="form-control" name="contactNo" value="<?php echo $_SESSION["contactNo"]?>" type="text">
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-3 control-label">Email:</label>
          <div class="col-lg-8">
              <input class="form-control" name="email" value="<?php echo $_SESSION["email"]?>" type="text">
          </div>
        </div>
        <div class="form-group">
